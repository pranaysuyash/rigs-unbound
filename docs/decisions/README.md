...
| ADR-0042 | Proposed - operator sign-off required; implementation in progress | Persistent infrastructure replaces the Floodgate singleton with autonomous, spatial machine effects. Runtime verification remains open. |
