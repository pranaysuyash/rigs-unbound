...
| Storage + migration discipline | Multi-version schema path with explicit v1/v2/legacy migration and recovery notes exists.                                                                                                                   | `src/game/state.ts:823-1360`, `src/game/storage.ts`, `src/game/contracts.ts`                   | Strong (in place)           |
