...
function makeProceduralTextureSet(
  ...
  const baseRoughness = clamp01(
    readLayerNumber(spec.roughness, ["base"], 0.76),
  );
...
function createSculptMaterial(
  ...
  const material = new THREE.MeshPhysicalMaterial({
    ...
    specularIntensity: clamp01(
      readLayerNumber(spec.specularIntensity, ["base"], 1.0),
    ),
...
export function createPatchworkTractorModel(
  options: ProceduralModelOptions = {},
): THREE.Group {
  ...
  materialMap["painted-metal"] = createSculptMaterial(
    ...
    {
      id: "painted-metal",
      name: "Painted aged metal",
      type: "standard",
      baseColor: "#593F2B",
      albedo: {
        dominant: "#593F2B",
        secondary: ["#89664B", "#C1A17F", "#322417"],
      },
      roughness: {
        base: 0.717,
        variation: 0.143,
        map: {
          path: "pbr-base/base_roughness.png",
          url: "pbr-base/base_roughness.png",
          channel: "roughness",
          source: "reference-pixel-extraction",
        },
      },
      metalness: { base: 0.35, variation: 0.1 },
      normal: {
        strength: 0.238,
        map: {
          path: "pbr-base/base_normal.png",
      ...
      localOverrides: [
        { id: "panel-seam-darkening", type: "seam", roughness: 0.82 },
        { id: "patina-cavity-mask", type: "stain", dirtAmount: 0.35 },
        { id: "edge-wear-mask", type: "scratch", roughness: 0.28 },
      ],
      surfaceFrequencyBands: [
        { id: "macro", frequency: 2, amplitude: 0.5 },
        { id: "meso", frequency: 14, amplitude: 0.35 },
        { id: "micro", frequency: 72, amplitude: 0.14 },
      ],
      textureResolution: 1024,
      textureProjection: { mode: "uv", repeat: [2, 2] },
      referencePbr: {
        usable: true,
        verdict: "pass",
        confidence: 0.86,
        ...
        maps: {
          ...
          ao: { path: "pbr-base/base_ao.png", url: "pbr-base/base_ao.png" },
        },
      },
    },
    options,
  ...
  materialMap["rubber"] = createSculptMaterial(
    "rubber",
    {
      ...
      qualityTier: "utility",
      baseColor: "#130D07",
      roughness: { base: 0.82, variation: 0.08 },
      metalness: { base: 0, variation: 0 },
      surfaceFrequencyBands: [
        { id: "macro", frequency: 1, amplitude: 0.2 },
        { id: "meso", frequency: 18, amplitude: 0.5 },
        { id: "micro", frequency: 80, amplitude: 0.1 },
      ],
      localOverrides: [{ id: "tire-dirt", type: "stain", dirtAmount: 0.4 }],
    },
    options,
  );
  materialMap["glass"] = createSculptMaterial(
    "glass",
    {
      ...
      qualityTier: "utility",
      baseColor: "#283038",
      roughness: { base: 0.24, variation: 0.05 },
      metalness: { base: 0, variation: 0 },
      localOverrides: [
        { id: "window-reflection", type: "gloss", roughness: 0.16 },
      ],
    },
    options,
  );
  materialMap["aged-hardware"] = createSculptMaterial(
    "aged-hardware",
    {
      ...
      qualityTier: "utility",
      baseColor: "#322417",
      roughness: { base: 0.55, variation: 0.12 },
      metalness: { base: 0.7, variation: 0.1 },
      localOverrides: [
        { id: "hardware-patina", type: "stain", dirtAmount: 0.25 },
      ],
    },
    options,
  );
  materialMap["emissive-lamp"] = createSculptMaterial(
    "emissive-lamp",
    {
      ...
      qualityTier: "utility",
      baseColor: "#FFEFB8",
      roughness: { base: 0.18, variation: 0.02 },
      metalness: { base: 0, variation: 0 },
      localOverrides: [
        {
          id: "headlight-emissive",
          type: "emissive",
          emissive: "#FFD27A",
  ...
  node_root_0.userData.sculptComponent = {
    ...
    topologyRationale:
      "Origin and bounds are inferred from the complete isolated vehicle silhouette.",
    parent: null,
    ...
    colorMaterialRecipe: {
      dominantAlbedo: "rgba(89, 63, 43, 1.0)",
      secondaryAlbedo: "rgba(193, 161, 127, 1.0)",
      materialClass: "metal",
      materialClassConfidence: 0.86,
    },
    localFeatures: ["root-bounds"],
  ...
  const endpoint_chassis_system_1 = makeAttachmentEndpoint(
    attachment_chassis_system_1,
  );
  ...
  node_chassis_system_1.userData.sculptComponent = {
    id: "chassis-system",
    name: "Chassis system",
    level: "macro",
    role: "body",
    ...
    topologyClass: "assembled-solid",
    topologyRationale:
      "The visible lower frame is a rigid assembled support inferred from wheel and body alignment.",
    parent: "root",
    material: "aged-hardware",
    materialLayers: ["aged-hardware"],
    dimensions: {
      width: 3.8,
      height: 0.7,
      depth: 1.7,
    ...
    colorMaterialRecipe: {
      dominantAlbedo: "rgba(50, 36, 23, 1.0)",
      secondaryAlbedo: "rgba(89, 63, 43, 1.0)",
      materialClass: "metal",
      materialClassConfidence: 0.78,
    },
    localFeatures: ["chassis-frame", "underbody-collider"],
    evidenceRefs: ["full-object"],
  };
  ...
  const mesh_chassis_system_1Geometry = endpoint_chassis_system_1
    ? new THREE.CylinderGeometry(
        endpoint_chassis_system_1.endRadius,
        endpoint_chassis_system_1.baseRadius,
        endpoint_chassis_system_1.length,
        32,
        12,
      )
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  ...
  mesh_chassis_system_1.userData.sculptComponent = {
    id: "chassis-system",
    name: "Chassis system",
    level: "macro",
    role: "body",
  ...
  const endpoint_body_and_attachments_2 = makeAttachmentEndpoint(
    attachment_body_and_attachments_2,
  );
  ...
  if (endpoint_body_and_attachments_2) {
    node_body_and_attachments_2.position.copy(
      endpoint_body_and_attachments_2.start,
    );
  ...
  node_body_and_attachments_2.userData.sculptComponent = {
    ...
    topologyClass: "assembled-solid",
    topologyRationale:
      "Cab, hood, fenders, and attachment hardware form distinct rigid assemblies around the chassis.",
    parent: "root",
    material: "painted-metal",
    materialLayers: ["painted-metal", "glass", "emissive-lamp"],
    dimensions: {
      width: 3.4,
      height: 2.2,
      depth: 1.8,
    ...
    transform: {
      position: [0.15, 1.45, 0],
      rotation: [0, 0, 0],
      scale: [1, 1, 1],
    },
    colorMaterialRecipe: {
      dominantAlbedo: "rgba(193, 161, 127, 1.0)",
      secondaryAlbedo: "rgba(137, 102, 75, 1.0)",
      materialClass: "metal",
      materialClassConfidence: 0.86,
    },
    localFeatures: ["body-panel-seams", "attachment-sockets"],
    evidenceRefs: ["full-object"],
  };
  ...
  const mesh_body_and_attachments_2Geometry = endpoint_body_and_attachments_2
    ? new THREE.CylinderGeometry(
        endpoint_body_and_attachments_2.endRadius,
        endpoint_body_and_attachments_2.baseRadius,
        endpoint_body_and_attachments_2.length,
        32,
        12,
      )
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  ...
  if (endpoint_body_and_attachments_2) {
    mesh_body_and_attachments_2.position.copy(
      endpoint_body_and_attachments_2.midpoint,
    );
    mesh_body_and_attachments_2.quaternion.copy(
      endpoint_body_and_attachments_2.quaternion,
    );
  }
  if (!endpoint_body_and_attachments_2) {
  ...
  mesh_body_and_attachments_2.userData.sculptComponent = {
    id: "body-and-attachments",
    name: "Body and attachments",
    level: "macro",
    role: "body",
  ...
  const endpoint_wheel_system_3 = makeAttachmentEndpoint(
    attachment_wheel_system_3,
  );
  ...
  node_wheel_system_3.userData.sculptComponent = {
    id: "wheel-system",
    name: "Four-wheel system",
    level: "meso",
    role: "body",
    primitive: "instanced-cluster",
    topologyClass: "assembled-solid",
    topologyRationale:
      "Four repeated wheel assemblies define mobility and require shared geometry with independent pivots.",
    parent: "chassis-system",
    material: "rubber",
    materialLayers: ["rubber", "aged-hardware"],
    dimensions: {
      width: 3.8,
      height: 1.35,
      depth: 1.8,
    ...
    colorMaterialRecipe: {
      dominantAlbedo: "rgba(50, 36, 23, 1.0)",
      secondaryAlbedo: "rgba(19, 13, 7, 1.0)",
      materialClass: "rubber",
      materialClassConfidence: 0.86,
    },
    localFeatures: ["tread-and-hub-instancing", "fastener-instancing"],
    evidenceRefs: ["full-object"],
  };
  ...
  const mesh_wheel_system_3Geometry = endpoint_wheel_system_3
    ? new THREE.CylinderGeometry(
        endpoint_wheel_system_3.endRadius,
        endpoint_wheel_system_3.baseRadius,
        endpoint_wheel_system_3.length,
        32,
        12,
      )
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  ...
  mesh_wheel_system_3.userData.sculptComponent = {
    id: "wheel-system",
    name: "Four-wheel system",
    level: "meso",
    role: "body",
  ...
  lights.userData.lightingFromPhoto = [
    {
      ...
      notes: "Soft neutral studio key; preserve panel readability.",
    },
    {
      name: "fill light",
      direction: "camera-front",
      notes: "Low-intensity fill prevents cab/wheel cavities from collapsing.",
    },
    {
      name: "environment and contact",
      direction: "neutral-background",
      notes:
        "Use exposure, tone mapping, and contact shadow to separate the silhouette.",
    },
  ];
...
export function createPatchworkTractorEnvironment(
