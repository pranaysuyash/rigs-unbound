...
const ARTIFACT_DIR = "/Users/pranay/.gemini/antigravity/brain/fb43e6e1-fb22-4252-927a-ecb065ff376f";
...
async function main() {
  ...
  try {
    ...
    fs.copyFileSync(area2Path, path.join(ARTIFACT_DIR, "area2_hood_dashboard.png"));
    ...
    fs.copyFileSync(area3Path, path.join(ARTIFACT_DIR, "area3_navigator_radar.png"));
    ...
    fs.copyFileSync(area4Path, path.join(ARTIFACT_DIR, "area4_soil_displacement.png"));
