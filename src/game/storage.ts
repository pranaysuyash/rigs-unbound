...
export const SAVE_KEY = "rigs-unbound.save.v10";
export const PREVIOUS_SAVE_KEY = "rigs-unbound.save.v9";
export const V8_SAVE_KEY = "rigs-unbound.save.v8";
export const V7_SAVE_KEY = "rigs-unbound.save.v7";
