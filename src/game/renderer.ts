...
import { VehicleVisualPresenter } from "./rendering/vehicle-visual";
...
export class GameRenderer {
  ...
  constructor(
    ...
    for (const id of RIG_IDS) {
      ...
      else if (id === "toy-buggy") parts = this.vehicles.createBuggy();
      else if (id === "marsh-skimmer") parts = this.vehicles.createSkimmer();
      else if (id === "snow-crawler-expedition-01")
        parts = this.vehicles.createSnowCrawler();
      else if (id === "spark-dune-runner-02")
        parts = this.vehicles.createDuneRunner();
      else if (id === "torque-field-cutter-02")
        parts = this.vehicles.createTorqueFieldCutter();
      else if (id === "heavy-utility-tow-recovery-01")
        parts = this.vehicles.createUtilityTow();
      else if (id === "harvester-combined-cultivator-01")
        parts = this.vehicles.createHarvester();
      else parts = this.vehicles.createCandidateRig(id);
    ...
    this.cargo = this.vehicles.createCargo();
